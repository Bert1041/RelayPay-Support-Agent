    ...
    >
      <div className="flex-1 w-full flex flex-col items-center justify-center">
        <div className="text-center">
          <h1 className="text-display-lg text-white drop-shadow-sm">
            Roxanne
          </h1>
          <p className="mt-2 text-body-lg text-neutral-200">
        ...
        <div className="relative bg-black/60 backdrop-blur-md rounded-xl border border-neutral-700">
          <Textarea
            ...
            className={cn(
              ...
              "bg-transparent text-white text-body-sm",
...
function QuickAction({ icon, label }: QuickActionProps) {
  return (
    <Button
      variant="outline"
      className="flex items-center gap-2 rounded-full border-neutral-700 bg-black/50 text-body-sm text-neutral-300 hover:text-white hover:bg-neutral-700"
    >
      {icon}
      <span>{label}</span>
    </Button>
